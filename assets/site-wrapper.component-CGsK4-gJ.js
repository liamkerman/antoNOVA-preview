import{s as C,Y as K,i as s,a8 as E,aK as nn,bj as tn,a9 as y,a as g,aN as Z,I as Y,c as l,d as h,C as f,bk as q,a0 as z,a1 as A,a2 as R,aT as $,g as i,k as D,j as r,A as u,m as v,bl as G,l as a,n as F,z as p,r as b,B,aU as N,b9 as en,H as d,J as X,L as J,S as Q,O as P,aW as on,Q as U,a3 as rn,y as W,bm as k,$ as an,K as sn,M as cn,bn as ln,a5 as gn,bo as pn,a6 as dn,aV as hn,a7 as mn,ax as _n,aR as un}from"./index-DWcdAism.js";class m{#n=C("Nezmeškaj začiatok najbližších termínov autoškoly - pridaj sa ešte DNES!");message=this.#n.asReadonly();#t=C(!0);visibleAtTop=this.#t.asReadonly();setVisibleAtTop(t){this.#t.set(t)}setMessage(t){this.#n.set(t)}clearMessage(){this.#n.set(null)}hasMessage(){return this.#n()!==null}static ɵfac=function(n){return new(n||m)};static ɵprov=K({token:m,factory:m.ɵfac,providedIn:"root"})}const fn=["aboutUs","contact"],Cn=["aboutUs","contact"];function j(o){return fn.includes(o)}class _{router=s(E);fragment=C(null);currentPath=C("");activeHomeSection=C(null);constructor(){this.updateFromRouter(),this.router.events.pipe(nn(t=>t instanceof tn)).subscribe(()=>this.updateFromRouter())}updateFromRouter(){const t=this.router.routerState.snapshot.root;this.fragment.set(t.fragment??null);const e=this.router.url.split("#")[0].split("?")[0].split("/").filter(Boolean);this.currentPath.set(e[1]??"")}setActiveHomeSection(t){this.activeHomeSection.set(t)}isHomeAnchorPath(t){return j(t)}getFragmentForPath(t){return j(t)?t:null}isLinkActive(t,n){const e=this.activeHomeSection();return t==="home"?this.currentPath()===n&&e==null:j(t)?e===t:this.currentPath()===n}static ɵfac=function(n){return new(n||_)};static ɵprov=K({token:_,factory:_.ɵfac,providedIn:"root"})}const Pn="O nás",vn="Kurzy a služby",Mn={headerAboutUs:Pn,courses:vn},On="About Us",bn="Courses and Services",yn={headerAboutUs:On,courses:bn};class I{languageService=s(y);registerTranslations(t){return this.languageService.t(t)}}const kn=["*"],wn=o=>({"custom-label":o});function xn(o,t){o&1&&N(0)}function Sn(o,t){if(o&1&&p(0),o&2){const n=b();B(" ",n.label()," ")}}class w extends I{path=g.required();langService=s(y);routerState=s(_);#n=s(Z);lang=this.langService.lang;constructor(){super(),Y(()=>{this.routerState.activeHomeSection(),this.#n.markForCheck()})}translatedPath=l(()=>this.langService.getRoutePath(this.path(),this.lang()));customLabel=g(!1);t=this.registerTranslations({sk:Mn,en:yn});label=l(()=>{const t=this.path(),n=t==="aboutUs"?"headerAboutUs":t;return t==="contact"?this.languageService.t({})(t)||"":this.t(n)||""});homePath=l(()=>this.langService.getRoutePath("home",this.lang()));linkUrl=l(()=>this.routerState.isHomeAnchorPath(this.path())?["/",this.lang(),this.homePath()]:["/",this.lang(),this.translatedPath()]);linkFragment=l(()=>this.routerState.getFragmentForPath(this.path()));isActive=l(()=>this.routerState.isLinkActive(this.path(),this.translatedPath()));static ɵfac=function(n){return new(n||w)};static ɵcmp=h({type:w,selectors:[["app-header-link"]],inputs:{path:[1,"path"],customLabel:[1,"customLabel"]},features:[R],ngContentSelectors:kn,decls:3,vars:8,consts:[[3,"routerLink","fragment","ngClass"]],template:function(n,e){n&1&&($(),i(0,"a",0),D(1,xn,1,0)(2,Sn,1,1),r()),n&2&&(u("active",e.isActive()),v("routerLink",e.linkUrl())("fragment",e.linkFragment())("ngClass",G(6,wn,e.customLabel())),a(),F(e.customLabel()?1:2))},dependencies:[f,q,z,A],styles:[`[_nghost-%COMP%]   a[_ngcontent-%COMP%] {
...
.submit-button[_nghost-%COMP%]   button[_ngcontent-%COMP%]:hover {
  background-color: var(--an-blue);
  opacity: 0.9;
}`],changeDetection:0})}const Tn=(o,t)=>["/",o,t],Ln=50;class H{#n=s(E);#t=s(y);#e=s(m);lang=this.#t.lang;scrolled=C(!1);announcementMessage=this.#e.message;announcementVisibleAtTop=this.#e.visibleAtTop;get announcementVisible(){return!!this.announcementMessage()&&this.announcementVisibleAtTop()}onWindowScroll(){this.scrolled.set(window.scrollY>Ln)}applicationPath=l(()=>this.#t.getRoutePath("ziadost",this.lang()));switchLang(t){const n=this.#n.url.split("/"),e=n[1]||"en",c=n.slice(2).join("/"),M=this.#t.translateRoute(c,e,t);M?this.#n.navigate(["/",t,M]):this.#n.navigate(["/",t])}static ɵfac=function(n){return new(n||H)};static ɵcmp=h({type:H,selectors:[["app-header"]],hostVars:2,hostBindings:function(n,e){n&1&&W("scroll",function(){return e.onWindowScroll()},k),n&2&&u("announcement-visible",e.announcementVisible)},decls:10,vars:8,consts:[[1,"left"],[1,"center"],["path","aboutUs"],["path","courses"],["path","contact"],[1,"right"],[1,"application-link",3,"routerLink"],["text","Prihláška na kurz","backgroundColor","black",1,"application-button",3,"rounded"]],template:function(n,e){n&1&&(i(0,"nav")(1,"div",0),d(2,"app-logo"),r(),i(3,"div",1),d(4,"app-header-link",2)(5,"app-header-link",3)(6,"app-header-link",4),r(),i(7,"div",5)(8,"a",6),d(9,"app-button",7),r()()()),n&2&&(u("scrolled",e.scrolled()),U("data-announcement",e.announcementVisible?"visible":"hidden"),a(8),v("routerLink",rn(5,Tn,e.lang(),e.applicationPath())),a(),v("rounded",!0))},dependencies:[f,z,A,w,x,S],styles:[`[_nghost-%COMP%] {
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
}`],changeDetection:0})}const ct=(o,t)=>t.titleKey;function lt(o,t){if(o&1&&(i(0,"a",24),p(1),r()),o&2){const n=b().$implicit,e=b();v("href",n.linkUrl,dn),a(),B(" ",e.t(n.linkKey)," ")}}function gt(o,t){if(o&1&&(i(0,"article",6),d(1,"span",15),i(2,"div",16)(3,"span",17)(4,"span",18),p(5),r()(),i(6,"h3",19),p(7),r()(),i(8,"div",20),d(9,"i",21),r(),i(10,"div",22)(11,"p",23),p(12),r(),D(13,lt,2,2,"a",24),r()()),o&2){const n=t.$implicit,e=t.$index,c=b();a(5),P(e+1),a(2),P(c.t(n.titleKey)),a(2),gn(pn("bi ",n.iconClass)),a(3),P(c.t(n.descKey)),a(),F(n.linkKey&&n.linkUrl&&n.linkUrl.length>0?13:-1)}}class O extends I{t=this.registerTranslations({sk:Wn,en:tt});currentYear=l(()=>new Date().getFullYear());registrationSteps=[{iconClass:"bi-telephone-fill",titleKey:"registrationStep1Title",descKey:"registrationStep1Desc"},{iconClass:"bi-clipboard2-check-fill",titleKey:"registrationStep2Title",descKey:"registrationStep2Desc",linkKey:"registrationStep2Link",linkUrl:""},{iconClass:"bi-geo-alt-fill",titleKey:"registrationStep3Title",descKey:"registrationStep3Desc"}];static ɵfac=(()=>{let t;return function(e){return(t||(t=an(O)))(e||O)}})();static ɵcmp=h({type:O,selectors:[["app-footer"]],features:[R],decls:20,vars:7,consts:[[1,"footer-registration"],[1,"footer-registration__title"],[1,"footer-registration__subtitle"],[1,"footer-registration__steps-wrap"],["aria-hidden","true",1,"footer-registration__timeline"],[1,"footer-registration__steps"],[1,"footer-registration__step"],[1,"main"],[1,"footer-nav"],["path","home"],["path","aboutUs"],["path","courses"],["path","contact"],["path","gdpr",1,"gdpr-link"],[1,"copyright"],["aria-hidden","true",1,"footer-registration__step-node"],[1,"footer-registration__step-header"],[1,"footer-registration__step-number-wrap"],[1,"footer-registration__step-number"],[1,"footer-registration__step-title"],[1,"footer-registration__step-icon"],["aria-hidden","true"],[1,"footer-registration__step-content"],[1,"footer-registration__step-desc"],["target","_blank","rel","noopener noreferrer",1,"footer-registration__step-link",3,"href"]],template:function(n,e){n&1&&(i(0,"footer")(1,"div",0)(2,"h2",1),p(3),r(),i(4,"p",2),p(5),r(),i(6,"div",3),d(7,"div",4),i(8,"div",5),sn(9,gt,14,7,"article",6,ct),r()()(),i(11,"div",7)(12,"nav",8),d(13,"app-nav-link",9)(14,"app-nav-link",10)(15,"app-nav-link",11)(16,"app-nav-link",12)(17,"app-nav-link",13),r(),i(18,"div",14),p(19),r()()()),n&2&&(U("aria-label",e.t("Pätička stránky")),a(3),P(e.t("registrationTitle")),a(2),P(e.t("registrationSubtitle")),a(4),cn(e.registrationSteps),a(3),U("aria-label",e.t("Hlavná navigácia pätičky")),a(7),ln(" ",e.t("Copyright")," © ",e.currentYear()," ",e.t("antoNOVA")," "))},dependencies:[f,T],styles:[`@charset "UTF-8";
[_nghost-%COMP%] {
  display: block;
...
.announcement-panel[_ngcontent-%COMP%]   .announcement-content[_ngcontent-%COMP%]   .announcement-text[_ngcontent-%COMP%]     a:hover {
  opacity: 0.9;
}`]})}const mt=["*"];class V{#n=s(m);#t=s(_);#e=s(_n);hasAnnouncement=()=>!!this.#n.message()&&this.#n.visibleAtTop();constructor(){un(()=>this.#o())}onScrollOrResize(){this.#o()}#o(){const t=typeof window<"u"?window.innerHeight:0;let n=null;for(const e of Cn){const c=document.getElementById(e);if(!c)continue;const M=c.getBoundingClientRect();if(M.top<t&&M.bottom>0){n=e;break}}this.#t.activeHomeSection()!==n&&(this.#t.setActiveHomeSection(n),this.#i())}#i(){setTimeout(()=>this.#e.tick(),0)}ngOnDestroy(){this.#t.setActiveHomeSection(null)}static ɵfac=function(n){return new(n||V)};static ɵcmp=h({type:V,selectors:[["app-site-wrapper"]],hostBindings:function(n,e){n&1&&W("scroll",function(){return e.onScrollOrResize()},k)("resize",function(){return e.onScrollOrResize()},k)},ngContentSelectors:mt,decls:6,vars:2,consts:[[1,"wrapper"]],template:function(n,e){n&1&&($(),i(0,"div",0),d(1,"app-announcement-panel")(2,"app-header"),i(3,"main"),N(4),r(),d(5,"app-footer"),r()),n&2&&u("has-announcement",e.hasAnnouncement())},dependencies:[f,H,O,L],styles:[`@charset "UTF-8";
[_nghost-%COMP%] {
  display: block;
  width: 100%;
}
...
main[_ngcontent-%COMP%] {
  ...
  max-width: 100%;
}`],changeDetection:0})}export{I as B,V as S,S as a,Hn as g};
