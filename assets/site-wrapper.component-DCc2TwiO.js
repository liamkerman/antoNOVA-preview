import{a as l,au as _,i,Q as m,R as x,b as r,C as g,av as j,aw as O,ax as L,ay as $,S as H,az as S,f as a,j as A,h as s,l as y,aA as U,u as N,aB as B,k as p,m as D,y as k,q as R,A as Z,aC as z,a4 as q,F as c,H as I,J as E,P as W,L as K,aD as Y,z as G,aE as J,O as V,aF as Q,s as X,Y as nn,a5 as tn,X as en}from"./index-6oI5htx9.js";const on="O nás",an="Kurzy a služby",sn="Dokumenty na stiahnutie",rn={headerAboutUs:on,courses:an,materials:sn},cn="About Us",ln="Courses and Services",pn="Documents for Download",gn={headerAboutUs:cn,courses:ln,materials:pn};class F{languageService=l(_);registerTranslations(n){return this.languageService.t(n)}}const dn=["*"],un=(o,n)=>["/",o,n],hn=()=>({exact:!0}),Cn=o=>({"custom-label":o});function mn(o,n){o&1&&z(0)}function _n(o,n){if(o&1&&k(0),o&2){const t=R();Z(" ",t.label()," ")}}class d extends F{path=i.required();translatedPath=m(()=>this.langService.getRoutePath(this.path(),this.lang()));customLabel=i(!1);langService=l(_);lang=this.langService.lang;t=this.registerTranslations({sk:rn,en:gn});label=m(()=>{const n=this.path(),t=n==="aboutUs"?"headerAboutUs":n;return n==="contact"?this.languageService.t({})(n)||"":this.t(t)||""});static ɵfac=(()=>{let n;return function(e){return(n||(n=x(d)))(e||d)}})();static ɵcmp=r({type:d,selectors:[["app-header-link"]],inputs:{path:[1,"path"],customLabel:[1,"customLabel"]},features:[H],ngContentSelectors:dn,decls:3,vars:10,consts:[["routerLinkActive","active",3,"routerLink","routerLinkActiveOptions","ngClass"]],template:function(t,e){t&1&&(S(),a(0,"a",0),A(1,mn,1,0)(2,_n,1,1),s()),t&2&&(y("routerLink",U(4,un,e.lang(),e.translatedPath()))("routerLinkActiveOptions",N(7,hn))("ngClass",B(8,Cn,e.customLabel())),p(),D(e.customLabel()?1:2))},dependencies:[g,j,O,L,$],styles:[`[_nghost-%COMP%]   a[_ngcontent-%COMP%] {
...
.submit-button[_nghost-%COMP%]   button[_ngcontent-%COMP%]:hover {
  background-color: var(--an-blue);
  opacity: 0.9;
}`],changeDetection:0})}class P{#n=l(J);#t=l(_);lang=this.#t.lang;switchLang(n){const t=this.#n.url.split("/"),e=t[1]||"en",f=t.slice(2).join("/"),T=this.#t.translateRoute(f,e,n);T?this.#n.navigate(["/",n,T]):this.#n.navigate(["/",n])}static ɵfac=function(t){return new(t||P)};static ɵcmp=r({type:P,selectors:[["app-header"]],decls:10,vars:1,consts:[[1,"left"],[1,"center"],["path","aboutUs"],["path","courses"],["path","materials"],["path","contact"],[1,"right"],["text","Prihláška na kurz","backgroundColor","black",1,"application-button",3,"rounded"]],template:function(t,e){t&1&&(a(0,"nav")(1,"div",0),c(2,"app-logo"),s(),a(3,"div",1),c(4,"app-header-link",2)(5,"app-header-link",3)(6,"app-header-link",4)(7,"app-header-link",5),s(),a(8,"div",6),c(9,"app-button",7),s()()),t&2&&(p(9),y("rounded",!0))},dependencies:[g,O,d,v,b],styles:[`[_nghost-%COMP%] {
  position: relative;
  z-index: 10;
  width: 100%;
}
...
}`]})}const fn="Copyright",vn="antoNOVA",bn={"Pätička stránky":"Pätička stránky","Hlavná navigácia pätičky":"Hlavná navigácia pätičky",Copyright:fn,antoNOVA:vn},Pn="Copyright",Mn="antoNOVA",On={"Pätička stránky":"Page footer","Hlavná navigácia pätičky":"Main footer navigation",Copyright:Pn,antoNOVA:Mn},yn={"nav.home":"Domov","nav.aboutUs":"O nás","nav.courses":"Kurzy a služby","nav.materials":"Dokumenty na stiahnutie","nav.contact":"Kontakt","nav.gdpr":"GDPR"},kn={"nav.home":"Home","nav.aboutUs":"About Us","nav.courses":"Courses and Services","nav.materials":"Documents for Download","nav.contact":"Contact","nav.gdpr":"GDPR"},wn=["*"],xn=(o,n)=>["/",o,n],Ln=()=>({exact:!0}),Hn=o=>({"custom-label":o});function Sn(o,n){o&1&&z(0)}function An(o,n){if(o&1&&k(0),o&2){const t=R();Z(" ",t.label()," ")}}class u extends F{path=i.required();translatedPath=m(()=>this.langService.getRoutePath(this.path(),this.lang()));customLabel=i(!1);langService=l(_);lang=this.langService.lang;t=this.registerTranslations({sk:yn,en:kn});label=m(()=>this.t(`nav.${this.path()}`)||"");static ɵfac=(()=>{let n;return function(e){return(n||(n=x(u)))(e||u)}})();static ɵcmp=r({type:u,selectors:[["app-nav-link"]],inputs:{path:[1,"path"],customLabel:[1,"customLabel"]},features:[H],ngContentSelectors:wn,decls:3,vars:10,consts:[["routerLinkActive","active",3,"routerLink","routerLinkActiveOptions","ngClass"]],template:function(t,e){t&1&&(S(),a(0,"a",0),A(1,Sn,1,0)(2,An,1,1),s()),t&2&&(y("routerLink",U(4,xn,e.lang(),e.translatedPath()))("routerLinkActiveOptions",N(7,Ln))("ngClass",B(8,Hn,e.customLabel())),p(),D(e.customLabel()?1:2))},dependencies:[g,j,O,L,$],styles:[`[_nghost-%COMP%]   a[_ngcontent-%COMP%] {
  text-decoration: none;
  color: white;
}
[_nghost-%COMP%]   a.custom-label[_ngcontent-%COMP%] {
  ...
  align-items: center;
  justify-content: center;
}`],changeDetection:0})}class h extends F{t=this.registerTranslations({sk:bn,en:On});currentYear=m(()=>new Date().getFullYear());static ɵfac=(()=>{let n;return function(e){return(n||(n=x(h)))(e||h)}})();static ɵcmp=r({type:h,selectors:[["app-footer"]],features:[H],decls:11,vars:5,consts:[[1,"main"],[1,"footer-nav"],["path","home"],["path","aboutUs"],["path","courses"],["path","materials"],["path","contact"],["path","gdpr",1,"gdpr-link"],[1,"copyright"]],template:function(t,e){t&1&&(a(0,"footer")(1,"div",0)(2,"nav",1),c(3,"app-nav-link",2)(4,"app-nav-link",3)(5,"app-nav-link",4)(6,"app-nav-link",5)(7,"app-nav-link",6)(8,"app-nav-link",7),s(),a(9,"div",8),k(10),s()()()),t&2&&(V("aria-label",e.t("Pätička stránky")),p(2),V("aria-label",e.t("Hlavná navigácia pätičky")),p(8),Q(" ",e.t("Copyright")," © ",e.currentYear()," ",e.t("antoNOVA")," "))},dependencies:[g,u],styles:[`[_nghost-%COMP%] {
  display: block;
...
.announcement-panel[_ngcontent-%COMP%]   .announcement-content[_ngcontent-%COMP%]   .announcement-text[_ngcontent-%COMP%]     a:hover {
  opacity: 0.9;
}`]})}const zn=["*"];class w{static ɵfac=function(t){return new(t||w)};static ɵcmp=r({type:w,selectors:[["app-site-wrapper"]],ngContentSelectors:zn,decls:6,vars:0,consts:[[1,"wrapper"]],template:function(t,e){t&1&&(S(),a(0,"div",0),c(1,"app-announcement-panel")(2,"app-header"),a(3,"main"),z(4),s(),c(5,"app-footer"),s())},dependencies:[g,P,h,M],styles:[`[_nghost-%COMP%] {
  display: block;
  width: 100%;
}
...
main[_ngcontent-%COMP%] {
  ...
  max-width: 100%;
}`],changeDetection:0})}export{F as B,w as S,b as a};
