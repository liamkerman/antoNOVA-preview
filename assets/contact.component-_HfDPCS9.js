var E=Object.defineProperty;var z=(r,e,t)=>e in r?E(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var P=(r,e,t)=>z(r,typeof e!="symbol"?e+"":e,t);import{a as D,B as S,S as I}from"./site-wrapper.component-Tih-vRcf.js";import{F as B,b as F,R as x,ɵ as G,N as R,c as K,d as V,e as L,T as W,a as Y}from"./textarea.component-DP89NKd5.js";import{i as $,Y as H,$ as N,d as j,C as A,a2 as T,g as C,z as w,j as b,H as Z,y as q,m as _,l as d,O as k}from"./index-fznfSLLT.js";import{C as J}from"./config.service-DfSiXlad.js";import"./icon.component-CtWxOuEU.js";const Q="Kontakt",U="Neváhajte sa s nami spojiť",X="Naša autoškola je vám k dispozícii počas celého roka. Kontaktujte nás pre viac informácií o našich kurzoch a službách.",tt="Adresa",et="anto NOVA, s. r. o.",nt="Račianska 69/A",ot="831 02, Bratislava",at="E-mail:",rt={title:Q,subtitle:U,description:X,address:tt,companyName:et,streetAddress:nt,postalCode:ot,email:at},st="Contact",it="Don't hesitate to get in touch with us",ct="Our driving school is available to you throughout the year. Contact us for more information about our courses and services.",lt="Address",mt="anto NOVA, s. r. o.",pt="Račianska 69/A",dt="831 02, Bratislava",gt="E-mail:",ut={title:st,subtitle:it,description:ct,address:lt,companyName:mt,streetAddress:pt,postalCode:dt,email:gt},y="logs-enabled";class f{#e=$(J);#n=this.#e.loggingSecret;constructor(){const e=this.#n;window.enableAppLogs=t=>{t===e?(localStorage.setItem(y,"1"),console.info("App logs enabled")):console.warn("Invalid app logs token")},window.disableAppLogs=()=>{localStorage.removeItem(y),console.info("App logs disabled")}}#t(){return localStorage.getItem(y)==="1"}info(e,t,...n){this.#t()&&console.info(`[${e}] ${t}`,...n)}warn(e,t,...n){this.#t()&&console.warn(`[${e}] ${t}`,...n)}error(e,t,n){this.#t()&&console.error(`[${e}] ${t}`,n)}withContext(e){return{info:(t,...n)=>this.info(e,t,...n),warn:(t,...n)=>this.warn(e,t,...n),error:(t,n)=>this.error(e,t,n)}}static ɵfac=function(t){return new(t||f)};static ɵprov=H({token:f,factory:f.ɵfac,providedIn:"root"})}function ft(r){Object.defineProperty(r.prototype,"logger",{get:function(){return $(f)},enumerable:!0,configurable:!0})}const ht={},_t={};var Ct=function(r,e,t,n,s,l){function a(u){if(u!==void 0&&typeof u!="function")throw new TypeError("Function expected");return u}for(var g=n.kind,i=g==="getter"?"get":g==="setter"?"set":"value",c=e||{},o,O=!1,M=t.length-1;M>=0;M--){var h={};for(var p in n)h[p]=p==="access"?{}:n[p];for(var p in n.access)h.access[p]=n.access[p];h.addInitializer=function(u){if(O)throw new TypeError("Cannot add initializers after decoration has completed");l.push(a(u||null))};var m=(0,t[M])(g==="accessor"?{get:c.get,set:c.set}:c[i],h);if(g==="accessor"){if(m===void 0)continue;if(m===null||typeof m!="object")throw new TypeError("Object expected");(o=a(m.get))&&(c.get=o),(o=a(m.set))&&(c.set=o),(o=a(m.init))&&s.unshift(o)}else(o=a(m))&&(g==="field"?s.unshift(o):c[i]=o)}O=!0},bt=function(r,e,t){for(var n=arguments.length>2,s=0;s<e.length;s++)t=n?e[s].call(r,t):e[s].call(r);return n?t:void 0};(()=>{var a;let r=[ft],e,t=[],n,s=S;var l=(a=class extends s{t=this.registerTranslations({sk:ht,en:_t});form=new B({email:new F(null),message:new F(null)});logger;handleSubmit(){this.logger.info("Contact form submitted:",this.form.value)}},n=a,(()=>{const i=typeof Symbol=="function"&&Symbol.metadata?Object.create(s[Symbol.metadata]??null):void 0;Ct(null,e={value:n},r,{kind:"class",name:n.name,metadata:i},null,t),l=n=e.value,i&&Object.defineProperty(n,Symbol.metadata,{enumerable:!0,configurable:!0,writable:!0,value:i})})(),P(a,"ɵfac",(()=>{let i;return function(o){return(i||(i=N(l)))(o||l)}})()),P(a,"ɵcmp",j({type:l,selectors:[["app-contact-form"]],features:[T],decls:9,vars:11,consts:[[1,"ac-content",3,"formGroup"],[1,"ac-content"],["formControlName","email",3,"label","placeholder","inverted"],["formControlName","message",3,"label","placeholder","inverted"],[3,"click","text","inverted"]],template:function(c,o){c&1&&(C(0,"form",0)(1,"div",1)(2,"h1"),w(3),b(),C(4,"h2"),w(5),b()(),Z(6,"app-textfield",2)(7,"app-textarea",3),C(8,"app-button",4),q("click",function(){return o.handleSubmit()}),b()()),c&2&&(_("formGroup",o.form),d(3),k(o.t("Kontaktný formulár")),d(2),k(o.t("Napíšte nám už teraz")),d(),_("label",o.t("E-mail"))("placeholder",o.t("Zadajte váš e-mail"))("inverted",!0),d(),_("label",o.t("Správa"))("placeholder",o.t("Miesto na vašu poznámku"))("inverted",!0),d(),_("text",o.t("Odoslať správu"))("inverted",!0))},dependencies:[A,x,G,R,K,V,L,W,Y,D],styles:[`[_nghost-%COMP%]   form[_ngcontent-%COMP%] {
  flex-grow: 0;
  flex-shrink: 0;
